...
const TableRowAcceso = ({ entrada, salida, motivo, lugar }) => {
...
export default function PantallaAccesos() {
	...
	if (estadoConsultaAccesos === "cargando") {
		...
		contenido = (
			<TableContainer component={Paper} sx={{ p: { xs: 0, sm: 2, md: 4 } }}>
				<Table size="small" >
					<TableHead>
						<TableRow >
